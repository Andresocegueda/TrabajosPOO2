...
class Servidor:
    ...
    def iniciar(self):
        ...
        # Recibir datos enviados por el cliente (hasta 1024 bytes) y decodificarlos a texto
        datos = conexion.recv(1024).decode()
        print("Mensaje recibido del cliente:", datos)

        # Crear un mensaje de respuesta personalizado para enviar al cliente
        respuesta = f"Recibí tu mensaje: '{datos}'"
        # Enviar la respuesta al cliente codificada en bytes
